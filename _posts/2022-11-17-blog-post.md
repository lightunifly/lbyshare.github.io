...
# Relativity - eigenchris

7. General Relativity Basics.
...
&=-\frac{1}{4}\delta\frac{\partial_\mu A_v\partial^\mu A^v-\partial_\mu A_v\partial^v A^\mu-\partial_v A_\mu\partial^\mu A^v+\partial_v A_\mu\partial^v A^\mu}{\delta\left(\partial_\lambda A_\kappa\right)}\\
&=-\frac{1}{2}\delta\frac{\partial_\mu A_v\partial^\mu A^v-\partial_\mu A_v\partial^v A^\mu}{\delta\left(\partial_\lambda A_\kappa\right)}\\
&=-\frac{1}{2}\delta_\mu^\lambda\delta_\nu^\kappa(\partial^\mu A^v-\partial^v A^\mu)-\frac{1}{2}\partial_\mu A_\nu\frac{\delta F^{\mu\nu}}{\delta\partial_\mu A_\nu}\\
&=-\frac{1}{2}\delta_\mu^\lambda\delta_\nu^\kappa F^{\mu\nu}-\frac{1}{2}\partial_\mu A_\nu\frac{g^{\mu s}g^{\nu t}\delta F_{st}}{\delta\partial_\mu A_\nu}\\
&=-\frac{1}{2}\delta_\mu^\lambda\delta_\nu^\kappa F^{\mu\nu}-\frac{1}{2}\partial_\mu A_\nu g^{\mu s}g^{\nu t}(\delta_s^\mu\delta_t^\nu-\delta_t^\mu\delta_s^\nu)\\
\end{aligned}
$$