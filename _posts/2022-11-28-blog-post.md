...
$$
The assumption in linear response theory is that $H(t)$ contains a weak perturbation on $A$ and the system will response linearly. And the central variables in fluctuation dissipation theorem is response function $\chi(t)$ and correlation function $c_{AB}(t)$.
